...
```
4. Run the demo!
Camera depends on you. If you use csi camera instead usb, you have to change csi://0. If you want to learn more about Camera Streaming and Multimedia, you can visit **[this link].(https://github.com/dusty-nv/jetson-inference/blob/master/docs/building-repo-2.md)**https://github.com/dusty-nv/jetson-inference/blob/master/docs/aux-streaming.md
``` bash
